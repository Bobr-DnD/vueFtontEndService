...
<template>
    <div v-for="perk, index in perks"
        ...
        <select v-if="perkPoints > 0" name="Perk" id="Perk" @change="addRow" :class="['min-w-fit max-w-4/5 my-2 px-4 py-2 bg-darkred-light border border-darkred-dark rounded-md text-darkred-dark font-gothic',
