...
<template>
    <div class="flex flex-col justify-center items-center">
        <form @submit.prevent class="flex flex-col w-full items-start justify-start p-2 font-univers mb-2  rounded-xl">
            ...
            <label :for="props.name + 'Name'" class=" text-darkred-light_gray font-semibold text-lg tracking-wide">
                Назва поля:
            </label>
        ...
        <form @submit.prevent class="flex flex-col w-full items-start justify-start p-2 font-univers mb-2 rounded-xl">
            ...
            <label :for="props.name + 'Value'"
                class="mr-2 w-24 text-darkred-light_gray font-semibold text-lg tracking-wide">
                Значення:
            </label>
